...
* Yes!
    ...
    Narrator: You may access your recipe book by left-clicking on it. To see a recipe, simply drag and drop the finalized item from your inventory to the recipe book slot. A recipe diagram will appear.
    Narrator: Here is what each connection means
