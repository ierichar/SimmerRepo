...
// * Yes!
// Tutorial: To move around use the WASD keys on your keyboard.
// Tutorial: You can RIGHT-CLICK on objects near you to interact with them.
// Tutorial: Use the LEFT mouse button to drag and drop food items and select them.
// Tutorial: You may access your recipe book in the top right by left-clicking on it. 
...
Tutorial: To move around use the WASD keys on your keyboard.
Tutorial: RIGHT-CLICK on objects near you to interact with them.
Tutorial: LEFT-CLICK to select, drag, and drop food items.
